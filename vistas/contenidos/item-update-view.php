...
?>
            ...
            <div class="full-box page-header">
                ...
                <p class="text-justify">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque laudantium necessitatibus eius iure
                    adipisci modi distinctio. Earum repellat iste et aut, ullam, animi similique sed soluta tempore cum
                    quis corporis!
                </p>
            </div>
			...
			?>
                <form class="form-neon FormularioAjax" action="<?= SERVER_URL ?>ajax/itemAjax.php" method="POST"      data-form="update" autocomplete="off">
                <input type="hidden" name="item_id_up" value="<?= $pagina[1]; ?>">
                    <fieldset>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control"
                                            name="item_codigo_up" value="<?php echo $campos['item_codigo']; ?>" id="item_codigo" maxlength="45">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}"
                                            class="form-control" name="item_nombre_up" value="<?php echo $campos['item_nombre']; ?>" id="item_nombre" maxlength="140">
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        value="<?php echo $campos['item_stock']; ?>" id="item_stock" maxlength="9">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}"
                                            class="form-control" name="item_detalle_up" value="<?php echo $campos['item_detalle']; ?>" id="item_detalle"
                                            maxlength="190">
                                    </div>
                                </div>
                            </div>
