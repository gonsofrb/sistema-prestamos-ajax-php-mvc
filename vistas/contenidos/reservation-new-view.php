 ...
 <div class="container-fluid">
     <ul class="full-box list-unstyled page-nav-tabs">
         ...
         <li>
             <a href="<?php echo SERVER_URL; ?>reservation-search/"><i class="fas fa-search-dollar fa-fw"></i> &nbsp;
                 BUSCAR POR FECHA</a>
         </li>
     </ul>
 </div>
 ...
 <div class="container-fluid">
     <div class="container-fluid form-neon">
         <div class="container-fluid">
             ...
             <p class="text-center">
                 <!--Ocultar botón si exite la sesion datos_cliente-->
             ...
             <div>
                 ...
                 <span class="text-danger">&nbsp; <i class="fas fa-exclamation-triangle"></i> Seleccione un
                     cliente</span>
                 <?php }else{?>
                 <form class="FormularioAjax" action="<?php echo SERVER_URL; ?>/ajax/prestamoAjax.php" method="POST"
                     data-form="loans" style="display: inline-block !important;">
                     <input type="hidden" name="id_eliminar_cliente"
                         value="<?php echo $_SESSION['datos_cliente']['id'];?>">
                 ...
                 <table class="table table-dark table-sm">
                     ...
                     <tbody>
                         <?php
                            if(isset($_SESSION['datos_item']) && count($_SESSION['datos_item'])>=1){
                                ...
                                foreach($_SESSION['datos_item'] as $items){
                                    ...
                                    //Formato que utiliza las bd de mysql
                         ...
                         <tr class="text-center">
                             ...
                             <td>
                                 <form class="FormularioAjax" action="<?= SERVER_URL ?>ajax/prestamoAjax.php" method="POST"
                     ...
                     <div class="row">
                         <div class="col-12 col-md-6">
                             <div class="form-group">
                                 ...
                                 <input type="date" class="form-control" name="prestamo_fecha_inicio_reg" value="<?php echo date("Y-m-d"); ?>"
                         ...
                         <div class="col-12 col-md-6">
                             <div class="form-group">
                                 ...
                                 <input type="time" class="form-control" name="prestamo_hora_inicio_reg" value="<?php echo date("H:i"); ?>"
                         ...
                         <div class="col-12 col-md-4">
                             <div class="form-group">
                                 ...
                                 <input type="text" pattern="[0-9.]{1,10}" class="form-control" readonly=""
                                     value="<?php echo number_format($_SESSION['prestamo_total'],2,'.','')?>" id="prestamo_total" maxlength="10">
                             </div>
                         </div>
                         <div class="col-12 col-md-4">
                             <div class="form-group">
     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <br>
                 <!--La talbla se genera dentro del controlador-->
 ...
 <div class="modal fade" id="ModalItem" tabindex="-1" role="dialog" aria-labelledby="ModalItem" aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 <button type="button" class="btn btn-primary" onclick="buscar_item();"><i
                         class="fas fa-search fa-fw"></i> &nbsp;
                     Buscar</button>
                 &nbsp; &nbsp;
                 <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
 ...
 <div class="modal fade" id="ModalAgregarItem" tabindex="-1" role="dialog" aria-labelledby="ModalAgregarItem"
     aria-hidden="true">
     <div class="modal-dialog" role="document">
         <form class="modal-content FormularioAjax" action="<?= SERVER_URL ?>ajax/prestamoAjax.php" method="POST"
