...
<!-- Content here-->
<div class="container-fluid">
    <form class="form-neon FormularioAjax" action="<?= SERVER_URL ?>ajax/clienteAjax.php" method="POST" data-form="save" autocomplete="off">
        <fieldset>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="(\d{8})([-]?)([A-Za-z]{1})" class="form-control" name="cliente_dni_reg"
