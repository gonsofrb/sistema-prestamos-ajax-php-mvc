<!--En estas vistas solo van a poder acceder usuarios de privilegios de nivel 1-->
<?php 
            ...
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <p class="text-center" style="font-size: 20px;">
                        Resultados de la busqueda <strong>“<?=$_SESSION['busqueda_usuario']; ?>”</strong>
                    </p>
                </div>
                <div class="col-12">
...
<div class="container-fluid">
        <?php   
            ...
            echo $inst_usuario->mostrar_usuarios_controlador($pagina[1],1,$_SESSION['privilegio_spm'],$_SESSION['id_spm'],$pagina[0],$_SESSION['busqueda_usuario']);
        ?>
</div>
