<?php           //id que inicia sesion              //id que viene por la url
            //Si entra en esta condicion significa que el id que inicia sesion no es el propietario de la cuenta que  desea cambiar los datos
        if($ilc->encryption($_SESSION['id_spm'])!=$pagina[1]){
...
<div class="full-box page-header">
    ...
    <p class="text-justify">
        ...
        blanditiis tempore amet alias placeat, obcaecati quaerat ullam, sunt est, odio aut veniam ratione.
            ...
            <!--Acceso a opciones solo al administrador-->
...
<div class="container-fluid">
    ...
    <form class="form-neon FormularioAjax" action="<?= SERVER_URL ?>ajax/usuarioAjax.php" method="POST"      data-form="update" autocomplete="off">                         
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="(\d{8})([-]?)([A-Za-z]{1})" class="form-control" name="usuario_dni_up"
                                id="usuario_dni" maxlength="20" value="<?php echo $campos['usuario_dni']; ?>" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control"
                                name="usuario_nombre_up" id="usuario_nombre" maxlength="35"  value="<?php echo $campos['usuario_nombre']; ?>" required="">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control"
                                name="usuario_apellido_up" id="usuario_apellido" maxlength="35"  value="<?php echo $campos['usuario_apellido']; ?>" required="">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="usuario_telefono_up"
                                id="usuario_telefono" maxlength="20"  value="<?php echo $campos['usuario_telefono']; ?>">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control"
                                name="usuario_direccion_up" id="usuario_direccion" maxlength="190"  value="<?php echo $campos['usuario_direccion']; ?>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control"
                                name="usuario_usuario_up" id="usuario_usuario" maxlength="35"  value="<?php echo $campos['usuario_usuario']; ?>" required="">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="usuario_email_up" id="usuario_email"
                                maxlength="70"  value="<?php echo $campos['usuario_email']; ?>" required="">
                        </div>
                    </div>

                <?php if($_SESSION['privilegio_spm']==1 && $campos['usuario_id']!=7) { ?>
                    <div class="col-12">
                        <div class="form-group">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <!--Si se cumple la condicion, la cuenta no es propia-->
        <?php if($ilc->encryption($_SESSION['id_spm'])!=$pagina[1]){ ?>
        ...
        <?php }else { ?>
            <!--Si no hay usuarios en la bd , nos muestra este mensaje de error.-->
